...
class CheckIfMovieInFavouriteListInDBUseCase
    extends UseCase<bool, CheckIfMovieInFavouriteListInDBParam> {
  ...
  Future<Either<AppError, bool>> call(
      CheckIfMovieInFavouriteListInDBParam params) async {
