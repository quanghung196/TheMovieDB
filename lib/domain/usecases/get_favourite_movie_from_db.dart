...
class GetFavouriteMovieFromDBUseCase extends UseCase<List<MovieEntity>, NoParams> {
  final MovieRepository _movieRepository;

  GetFavouriteMovieFromDBUseCase(this._movieRepository);

  @override
  Future<Either<AppError, List<MovieEntity>>> call(NoParams params) async {
    return await _movieRepository.getFavouriteMovieFromDB();
  }
}
