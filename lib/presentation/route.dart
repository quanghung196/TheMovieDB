...
import 'package:custom_listview_with_json_data/presentation/journeys/all_movie/view_all_movie_screen.dart';
...
class Routes {
  static Map<String, WidgetBuilder> getRoutes(RouteSettings routeSettings) => {
        ...
        RouteList.ALL_MOVIE_SCREEN: (context) => ViewAllMovieScreen(
              agrument: routeSettings.arguments as ViewAllMovieScreenAgrument,
            ),
      };
}
